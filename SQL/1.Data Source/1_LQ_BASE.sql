...
-- ==========Transactions================
create table FCO_LOOKALIKE_TRANSACTION compress for query high pctfree 0
as
select T.GROUP_LOYALTY_MEMBER_NUMBER,
NVL(P.ITEM_CAT,S.ITEM_CAT) as ITEM_CAT,
...
and   t.transaction_date between '31 Aug 2014' and '31 Aug 2015'
